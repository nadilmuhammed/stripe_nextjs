  ...
  return (
    <ul
      className={`my-dropdown static duration-300 shadow-md ${dropdownClass} ${
        dropdown ? "block mt-5 lg:mt-0 text-gray-600" : "hidden"
      }`}>
...
const Navbar = () => {
  return (
    <ul className="flex flex-col lg:flex-row menus absolute left-0 lg:top-full lg:bg-transparent w-full lg:w-auto lg:static px-2 lg:px-0">
