        ...
        return (
          ...
          >
            <div className="container flex justify-between items-center  py-1 lg:py-2  gap-2 lg:gap-1  xl:gap-20 sm:gap-[3.5rem] mx-auto">
              ...
              <div className="flex flex-col justify-center items-center gap-1 mr-4">

                <span className={`${scrolled && "text-white"} hidden text-center text-[10px] text-gray-700 max-[425px]:ml-[2.2rem] max-[768px]:block max-[768px]:ml-[2rem] `} style={{fontSize:"8.5px"}}>Do you need urgent support?</span>
                ...
                <div className={`${scrolled && "text-white"} flex justify-evenly gap-10 divide-x-[2px] text-gray-700 max-[425px]:gap-4 max-[425px]:ml-[2rem]`}>
                  ...
                  <div className="flex items-center gap-3 border-none sm:px-4">
                    <div className="flex flex-col gap-1 justify-center items-center md:flex-col lg:flex-row">
                      <Link
                        ...
                        target="_blank"
                      >
                        <LuPhone className="bg-primary text-white text-[2.5rem] rounded-full px-2 max-[375px]:text-[2.2rem]" />
                  ...
                  <div className="flex items-center border-none ">
                    <Link
                      ...
                      target="_blank"
                    >
                      <MdOutlineEmail className="bg-red-500 text-white text-[2.5rem] rounded-full p-2 max-[375px]:text-[2.2rem]  " />
                  ...
                  <div className="flex items-center border-none">
                    <Link
                      ...
                      target="_blank"
                    >
                      <i className="lab la-whatsapp bg-[var(--secondary)] text-[var(--neutral-700)] text-white text-2xl p-2 rounded-full max-[375px]:text-lg"></i>
                    </Link>
                  </div>
                </div>
              </div>
